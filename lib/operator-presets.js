...
const PRESETS = {
  nutribake_editorial_v1: {
    ...
    basic_strategy: {
      narrative_mode: 'auto', voice_provider: 'minimax',
      voice_persona: 'Indonesian_professional_anchor_vv2', voice_speed: 1.0, voice_volume: 1.0,
      tts_model_quality: 'speech-2.8-turbo', target_language: 'id-ID',
      target_demographic: 'ibu_rumah_tangga', target_demographic_custom: '',
      promotion_style: 'Softselling', enable_audio_segment: false,
    ...
    product_bridging: {
      is_bridging_active: false, bridging_mode: 'manual_input',
      bridge_at_clip: 2, bridge_duration_clips: 1
    },
    visual_swap: {
      is_vso_active: true, character_concept: 'faceless', subject_demographic: 'syari_classic',
      wardrobe_style: 'sequential', wardrobe_style_custom: '',
      lighting_style: 'window_daylight', lighting_style_custom: '',
      visual_style_preset: '3d_claymation_cozy', visual_identity_preset_id: 'hands_only_muslimah_sage_kitchen',
      visual_identity_inline_config: null, visual_overrides_json: null
    },
    workflow: {
      approval_mode: 'storyboard', enable_tts: true, enable_glabs: true, enable_ffmpeg: true,
      ffmpeg_sync_option: 'smart_sync', ffmpeg_video_scale: 1.0,
      ffmpeg_sfx_volume: 0.0, ffmpeg_bgm_volume: 0.0,
  ...
  product_campaign_v1: {
    ...
    basic_strategy: {
      narrative_mode: 'auto', voice_provider: 'minimax',
      voice_persona: 'Indonesian_casual_reporter_vv2', voice_speed: 1.0, voice_volume: 1.0,
      tts_model_quality: 'speech-2.8-turbo', target_language: 'id-ID',
      target_demographic: 'custom', target_demographic_custom: '',
      promotion_style: 'Softselling', enable_audio_segment: false,
      sfx_setting: 'without_sfx', enable_vo_audit: 1, nextcloud_parent_folder: '/MAKNA_Assets',
    ...
    product_bridging: {
      is_bridging_active: true, bridging_mode: 'select_existing',
      bridge_at_clip: 3, bridge_duration_clips: 1
    },
    visual_swap: {
      is_vso_active: false, character_concept: 'faceless', subject_demographic: 'syari_classic',
      wardrobe_style: 'amber_terracotta', wardrobe_style_custom: '',
      lighting_style: 'window_daylight', lighting_style_custom: '',
      visual_style_preset: '3d_claymation_cozy', visual_identity_preset_id: null,
      visual_identity_inline_config: null, visual_overrides_json: null
    },
    workflow: {
  ...
  product_education_v1: {
    schema_version: '2',
    label: 'Product Education — OPC',
    campaign_kinds: ['product_campaign'],
    planner_defaults: { target_audience: '', content_goal: 'Product education, trust, saves, dan consideration.' },
    basic_strategy: {
      narrative_mode: 'Educational Review', voice_provider: 'minimax',
      voice_persona: 'Indonesian_compelling_storyteller_vv2', voice_speed: 1.0, voice_volume: 1.0,
      tts_model_quality: 'speech-2.8-turbo', target_language: 'id-ID',
      target_demographic: 'custom', target_demographic_custom: '',
      promotion_style: 'Softselling', enable_audio_segment: false,
      sfx_setting: 'without_sfx', enable_vo_audit: 1, nextcloud_parent_folder: '/MAKNA_Assets',
      ai_directive: 'Jelaskan manfaat dan penggunaan hanya dari fakta pada snapshot produk.',
      mandatory_outro_line: ''
    },
    visual_engine: {
      visual_style: 'Cinematic', visual_mode: 'hybrid_lock', video_model: 'veo_31_lite',
  ...
  product_problem_solution_v1: {
    schema_version: '2',
    label: 'Product Problem–Solution Demo — OPC',
    campaign_kinds: ['product_campaign'],
    planner_defaults: { target_audience: '', content_goal: 'Problem awareness, product demonstration, dan conversion.' },
    basic_strategy: {
      narrative_mode: 'Storytelling', voice_provider: 'minimax',
      voice_persona: 'Indonesian_expressive_podcaster_vv2', voice_speed: 1.0, voice_volume: 1.0,
      tts_model_quality: 'speech-2.8-turbo', target_language: 'id-ID',
      target_demographic: 'custom', target_demographic_custom: '',
      promotion_style: 'Hard Sell', enable_audio_segment: false,
      sfx_setting: 'without_sfx', enable_vo_audit: 1, nextcloud_parent_folder: '/MAKNA_Assets',
      ai_directive: 'Bangun alur masalah–solusi tanpa klaim di luar snapshot produk.',
      mandatory_outro_line: ''
    },
    visual_engine: {
      visual_style: 'UGC', visual_mode: 'hybrid_lock', video_model: 'veo_31_lite',
  ...
  dapurbotani_kampanye_produk_4_klip: {
    ...
    basic_strategy: {
      ...
      target_demographic: 'custom', target_demographic_custom: '',
      promotion_style: 'Softselling', enable_audio_segment: false,
      sfx_setting: 'without_sfx', enable_vo_audit: 1,
      nextcloud_parent_folder: '/MAKNA_Assets/DapurBotani',
...
export function isOperatorPresetCompatible(preset, campaignKind) {
  const target = typeof preset === 'string' ? (getOperatorPresetConfig(preset) || { key: preset }) : preset;
