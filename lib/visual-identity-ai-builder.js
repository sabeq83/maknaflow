...
1. Subject Demographic (subject.demographic_key & subject.custom_description):
   ...
   - Non-human / Animal / Mascot: For any animal, creature, mascot, or fantasy character (e.g. British Shorthair Cat Barista, robot, animated character), set subject.kind to "animal" or "mascot_object", subject.demographic_key to "custom" or "not_applicable", and set subject.faceless_mode to "not_applicable". You MUST write a rich, vivid, complete physical description of the character in subject.custom_description (e.g., "charming British Shorthair cat barista with plush grey fur, expressive round amber eyes, neat whiskers, standing on hind legs holding barista tools").
