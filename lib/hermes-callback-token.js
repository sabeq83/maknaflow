...
function signingSecret() {
  const secret = process.env.MAKNA_HERMES_CALLBACK_SIGNING_SECRET || process.env.HERMES_CALLBACK_SECRET || '';
  if (secret.length < 32) throw new Error('MAKNA_HERMES_CALLBACK_SIGNING_SECRET atau HERMES_CALLBACK_SECRET wajib minimal 32 karakter.');
  return secret;
}
