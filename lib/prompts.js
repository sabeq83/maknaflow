...
5. ATURAN SEMANTIC STERILIZATION & SILENT KINETICS: AI Video memiliki filter audio yang ketat. Anda WAJIB merancang seluruh adegan menggunakan prinsip "Silent Kinetics" (gerakan hening) dan "Pure Optics" (fokus optik murni):
   ...
   - Sebagai gantinya, gunakan gerakan hening non-benturan (seperti "memegang produk secara tenang", "tangan diam di samping wadah", "mengaduk perlahan cairan yang sudah tenang").
   - Ganti kata-kata ambigu ("powder", "white liquid", "thick mixture", "high-viscosity liquid", "milky", "pills", "drugs", "liquid transfer", "viscous") dengan istilah netral ("nutritional beverage", "creamy vanilla smoothie", "health supplement", "velvet texture").
