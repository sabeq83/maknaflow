...
export async function updateUniverseProfile(id, data) {
  ...
  values.push(id);
  return dbRun(`UPDATE universe_profiles SET ${updates.join(', ')} WHERE id = $${idx}`, values);
}
...
export async function updateUniverseCharacter(id, data) {
  ...
  updates.push(`updated_at = CURRENT_TIMESTAMP`);
  values.push(id);
  return dbRun(`UPDATE universe_characters SET ${updates.join(', ')} WHERE id = $${idx}`, values);
}
...
export async function updateUniverseLocation(id, data) {
  ...
  updates.push(`updated_at = CURRENT_TIMESTAMP`);
  values.push(id);
  return dbRun(`UPDATE universe_locations SET ${updates.join(', ')} WHERE id = $${idx}`, values);
}
