...
export async function createPillarCampaign(campaign) {
  ...
  return db.prepare(`
    INSERT INTO pillar_campaigns (
      id, account_name, source_planner_id, campaign_name, status, content_pillar, custom_hook, visual_action_guideline, custom_instruction, ai_directive, mandatory_outro_line, brand_profile_id,
