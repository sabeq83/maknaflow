...
import { executeWithKeyPool, uploadVideoToGemini, generateContentFlexible, getResolvedGeminiModels, GEMINI_MODELS } from './gemini.js';
...
import { getMicroPacingTemplate } from './words-per-clip-presets.js';
...
Output harus berupa JSON valid sesuai skema:
{
  ...
  "storyboard": [
    {
      "scene": 1,
      "duration": "${campaign.clip_duration || 8}s",
  ...
  "t2v_prompts": [
    {
      "clip": 1,
      "prompt": "(VERTICAL 9:16) --ar ${campaign.aspect_ratio || '9:16'} --no landscape [LAYER 0: VISUAL TRUTH & ANCHORS] (Geometric Truth: [MANDATE 50 - Shape & Material Extraction]), (Biometric Anchor: [MANDATE 29 - 3-Point Character Lock]), (Wardrobe: [Wardrobe Lock]). [LAYER 1: SCENE & OPTICS] (Location: [MANDATE 33 - Verbatim Scene Lock]), (Lens: [Camera Spec]), (Camera Move: [Insert Kinetic Logic]), (Lighting: [Lighting Mood]). [LAYER 2: MICRO-PACING & ACTION (MANDATE 49)] ${getMicroPacingTemplate(campaign.clip_duration || 8, false, { isGeneric: true, hasTransitionLock: true })} [LAYER 3: SFX] SFX: [Insert SFX]"
    }
  ],
  "t2i_prompts": [
    {
  ...
  "i2v_prompts": [
    {
      "clip": 1,
      "prompt": "(VERTICAL 9:16) --ar ${campaign.aspect_ratio || '9:16'} --no landscape [LAYER 1: INPUT & TRUTH LOCK] (Start Frame: [Filename]), (Consistency: MAX). (Geometric Truth: [MANDATE 50 - Shape & Material Extraction]). [LAYER 2: MICRO-PACING & ACTION (MANDATE 49)] ${getMicroPacingTemplate(campaign.clip_duration || 8, false, { isGeneric: true, hasTransitionLock: true })} [LAYER 3: SFX] SFX: [Insert SFX]"
    }
  ],
