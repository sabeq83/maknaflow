...
export async function generateHybridPromptMatrix({ episode, script, profile, visualIdentity, universe, kbSnapshot }) {
  ...
  const prompt = `
    ...
    Ketentuan Pembuatan Rencana Hybrid & Multi-Speaker:
    ...
    7. Daftarkan karakter yang aktif/berbicara pada shot tersebut di field "subjects" menggunakan key unik dari universe (misal: "cat_detective", "broom_sweeper", dst.) jika terdaftar di Universe Context.
    8. Pemetaan Fokus Speaker/Listener (Speaker-Aware Layout):
