...
const VALID_TRANSITIONS = {
  ...
  [AGENT_RUN_STATES.PRODUCING]: [
    ...
    AGENT_RUN_STATES.PRODUCTION_FAILED
  ],
  [AGENT_RUN_STATES.READY_TO_PUBLISH]: [
...
export function shouldStartAgentAutomationWorker(env = process.env) {
  return String(env?.ENABLE_AGENT_AUTOMATION_WORKER || '').trim().toLowerCase() === 'true';
}
