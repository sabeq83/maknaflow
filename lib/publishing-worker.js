  ...
  if (job.platform === 'facebook') {
    try {
      ...
      if (job.publish_mode === 'draft') {
        ...
        if (process.env.ENABLE_FACEBOOK_LIVE !== 'true') {
          throw new Error('Publikasi Facebook Live dinonaktifkan (ENABLE_FACEBOOK_LIVE != true). Memerlukan persetujuan & pengaktifan flag.');
        }
