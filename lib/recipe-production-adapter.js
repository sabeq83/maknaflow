...
export async function processRecipeCampaignCreative({ item, campaign, job }) {
  ...
  const visualMandate = [
    ...
    `- FOOD SUBJECT TRUTH: Makanan yang dibuat di SELURUH klip adalah 100% konsisten dengan judul resep: "${recipeTitle}". DILARANG KERAS memunculkan objek makanan lain yang tidak ada di resep.`,
