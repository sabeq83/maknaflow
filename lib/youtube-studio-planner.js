...
export async function generateScript(episode, blueprint, researchBrief, universe, visualIdentity) {
  ...
  const prompt = `
    ...
    - Bahasa Penulisan: Seluruh teks "voiceover" WAJIB ditulis dalam bahasa yang sesuai dengan Locale ("${episode.locale}"). Jika locale adalah "en-US", tulis "voiceover" dalam Bahasa Inggris yang natural, ekspresif, dan menarik. Bidang deskriptif seperti visual_direction atau purpose boleh menggunakan Bahasa Indonesia atau Bahasa Inggris.
