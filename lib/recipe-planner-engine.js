...
1. KESELARASAN JUDUL & HOOK: Hook video (Scene 1) wajib langsung menyebutkan payoff/keunggulan dari judul resep ("title").
2. KONSISTENSI BAHAN (INGREDIENTS) & LANGKAH (STEPS):
...
3. KRONOLOGIS LANGKAH MEMASAK & STORYBOARD:
   ...
   - "storyboard": Adegan 4-scene wajib mengikuti alur kronologis:
     * Scene 1 (Hook): Hasil akhir menggugah selera / masalah kuliner yang dipecahkan.
     * Scene 2 (Prep & Mixing): Penakaran dan pencampuran bahan awal sesuai steps 1-2.
     * Scene 3 (Execution / Cooking): Pengolahan/pemasakan utama sesuai steps lanjutan.
     * Scene 4 (Plating & CTA): Penyajian hidangan matang yang identik dengan bahan yang dimasak, diakhiri ajakan mencoba resep.
4. CHEF TIPS: 1-2 tips chef praktis yang relevan langsung dengan teknik memasak resep tersebut.
