...
PRINSIP RESEP KULINER (CANONICAL RECIPE REQUIREMENTS):
- Setiap baris resep WAJIB memiliki:
  1. "ingredients": Daftar bahan-bahan lengkap dengan takaran spesifik (misal: "1 sdt", "150 ml", "1/2 buah", dsb.) dan cantumkan "product_id" produk katalog terkait.
  2. "steps": Langkah-langkah memasak berurutan yang menyebutkan penggunaan alat dan bahan secara jelas.
  3. "chef_tips": 1-2 tips chef praktis agar resep anti-gagal.
  4. "storyboard": 4 adegan video vertikal 9:16 (Scene 1: Hook, Scene 2: Persiapan Bahan, Scene 3: Eksekusi Alat/Pengolahan, Scene 4: Plating & CTA) lengkap dengan visual shot dan narasi Voice-Over (VO).
