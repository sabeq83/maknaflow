...
import { buildDistributionPlan, normalizeGeneratedPlannerRows, normalizePillars, normalizePlannerFocus, validatePlannerDraft } from './content-planner-contract.js';
...
export async function executeContentPlanner(plannerId) {
  ...
  try {
    ...
    const focus = normalizePlannerFocus(planner_focus);
