...
## V2.28.20 — Fix: Exclude t2v visual mode from hybrid planner (27/08/2026)
- Enforce t2i_i2v exclusively for all visual shots generated by hybrid planner
- Add repository failsafe to auto-fill i2v_prompt if missing
- Deploy changes to Dev Mac Mini server
...
- Memastikan kestabilan filter graph dengan menggunakan filter asplit untuk menggandakan stream Voice-Over
...
- Tambahkan audit fingerprint aman, regression test, dan deploy Mac Mini Dev
