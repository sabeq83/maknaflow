...
async function applyStagingMigrations(client) {
  ...
  `);
  await client.query(`CREATE INDEX IF NOT EXISTS brand_products_brand_idx ON brand_products (tenant_id, brand_profile_id, is_active);`);
  await client.query(`CREATE INDEX IF NOT EXISTS brand_products_product_idx ON brand_products (tenant_id, product_id);`);
  ...
  `);
  await client.query(`CREATE INDEX IF NOT EXISTS campaign_product_bindings_product_idx ON campaign_product_bindings (tenant_id, product_id, brand_profile_id);`);
