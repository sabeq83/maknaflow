          ...
          {activeAsset && (
            <div className="output-panel" ref={outputPanelRef}>
              ...
              {tab === 'captions' && (
                <div>
                  {(() => {
                    const universalCaption = activeAsset.caption || activeAsset.universal_caption || (typeof activeAsset.social_media_package === 'object' ? activeAsset.social_media_package?.caption : '') || activeAsset.tiktok_caption || activeAsset.ig_caption || '';
                    return (
