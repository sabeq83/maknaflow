...
export default function Dashboard() {
  ...
  const getBrandBadgeStyle = (accountName) => {
    ...
    if (acc === 'siasatsehat' || acc.includes('sehat') || acc.includes('health')) {
      return { background: 'var(--status-success-soft)', border: '1px solid rgba(16, 185, 129, 0.5)', color: '#6ee7b7' };
    }
  ...
  const getStatusBadge = (status) => {
    if (status === 'Published') {
      return <span style={{ padding: '3px 10px', borderRadius: '8px', background: 'rgba(16, 185, 129, 0.18)', border: '1px solid var(--status-success)', color: 'var(--status-success)', fontSize: '11px', fontWeight: 700 }}>Published</span>;
    }
    if (status === 'Scheduled') {
      return <span style={{ padding: '3px 10px', borderRadius: '8px', background: 'rgba(245, 158, 11, 0.18)', border: '1px solid var(--status-warning)', color: 'var(--status-warning)', fontSize: '11px', fontWeight: 700 }}>Scheduled</span>;
    }
        ...
        <div style={{ maxWidth: '1380px', width: '100%', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <span style={{ fontSize: '11px', fontWeight: 700, padding: '3px 10px', borderRadius: '20px', background: 'rgba(6, 182, 212, 0.15)', border: '1px solid rgba(6, 182, 212, 0.4)', color: 'var(--link)' }}>
                  Decoupled V2.0 Active
                </span>
                <span style={{ fontSize: '11px', fontWeight: 700, padding: '3px 10px', borderRadius: '20px', background: 'rgba(59, 130, 246, 0.12)', border: '1px solid rgba(59, 130, 246, 0.3)', color: '#93c5fd' }}>
                  🔒 Internal Enterprise
                </span>
              </div>
              <p style={{ color: 'var(--text-muted)', fontSize: '13px', margin: '4px 0 0 0' }}>
                Ringkasan Eksekutif & Akses Cepat ContentFlow Platform
              </p>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <Link
                href="/"
                style={{
                  padding: '10px 16px', borderRadius: '12px', background: 'var(--bg-card)', border: '1px solid var(--border)',
                  color: 'var(--text-secondary)', fontSize: '12px', fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px'
                }}
              >
                🌐 Public Home
              </Link>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px', marginBottom: '24px' }}>
            ...
            <div style={{
              ...
              border: '1px solid rgba(6, 182, 212, 0.3)', boxShadow: '0 8px 32px var(--overlay-subtle)', position: 'relative', overflow: 'hidden'
            }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                <span style={{ fontSize: '32px', fontWeight: 800, color: 'var(--link)', letterSpacing: '-0.02em' }}>{stats?.contentReadyCount ?? '—'}</span>
                <span style={{ fontSize: '11px', color: 'var(--status-success)', fontWeight: 700, background: 'var(--status-success-soft)', padding: '2px 8px', borderRadius: '6px', border: '1px solid var(--status-success-soft)' }}>Video Ready</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              border: '1px solid var(--status-success-soft)', boxShadow: '0 8px 32px var(--overlay-subtle)', position: 'relative', overflow: 'hidden'
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                <span style={{ fontSize: '32px', fontWeight: 800, color: 'var(--status-success)', letterSpacing: '-0.02em' }}>{stats?.activeCampaignCount ?? '—'}</span>
            ...
            <div style={{
              padding: '20px 22px', borderRadius: '16px', background: 'linear-gradient(145deg, var(--bg-card) 0%, var(--status-warning-soft) 100%)',
              border: '1px solid var(--status-warning-soft)', boxShadow: '0 8px 32px var(--overlay-subtle)', position: 'relative', overflow: 'hidden'
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                <span style={{ fontSize: '32px', fontWeight: 800, color: 'var(--status-warning)', letterSpacing: '-0.02em' }}>{stats?.productCount ?? '—'}</span>
            ...
            <div style={{
              ...
              border: '1px solid rgba(99, 102, 241, 0.35)', boxShadow: '0 8px 32px var(--overlay-subtle)', position: 'relative', overflow: 'hidden'
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                <span style={{ fontSize: '24px', fontWeight: 800, color: 'var(--status-neutral)', letterSpacing: '-0.02em' }}>3 / 3 Nodes</span>
                <span style={{ fontSize: '11px', color: 'var(--status-success)', fontWeight: 700, background: 'var(--status-success-soft)', padding: '2px 8px', borderRadius: '6px', border: '1px solid var(--status-success-soft)' }}>PostgreSQL Node 3</span>
              </div>
            </div>
          ...
          <div style={{ padding: '22px 24px', borderRadius: '18px', background: 'var(--bg-card)', border: '1px solid var(--border)', marginBottom: '28px', boxShadow: '0 12px 40px var(--overlay-subtle)', backdropFilter: 'blur(20px)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Pintas Akses Modul Utama</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
              ...
              >
                <div style={{ width: '38px', height: '38px', borderRadius: '10px', background: 'var(--status-success-soft)', border: '1px solid var(--status-success-soft)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>📅</div>
                <div>
              ...
              >
                <div style={{ width: '38px', height: '38px', borderRadius: '10px', background: 'var(--status-warning-soft)', border: '1px solid var(--status-warning-soft)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>⚡</div>
                <div>
                ...
                {brandOverview.map((b) => (
                  <div
                    ...
                    style={{
                      ...
                      border: '1px solid var(--border)', boxShadow: '0 8px 32px var(--overlay-subtle)', position: 'relative'
                    }}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                      <span style={{
                      ...
                      <span style={{ fontSize: '11px', color: 'var(--status-success)', fontWeight: 700, padding: '3px 8px', borderRadius: '6px', background: 'var(--status-success-soft)', border: '1px solid var(--status-success-soft)' }}>
                        Active Account
                      </span>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', marginBottom: '16px', background: 'var(--bg-primary)', padding: '10px 12px', borderRadius: '12px', border: '1px solid var(--border)' }}>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '10px', color: 'var(--link)', fontWeight: 700 }}>🎵 TikTok</div>
                      ...
                      <div style={{ textAlign: 'center', borderLeft: '1px solid var(--border-subtle)', borderRight: '1px solid var(--border-subtle)' }}>
                        <div style={{ fontSize: '10px', color: 'var(--link)', fontWeight: 700 }}>📘 FB</div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        ...
                        <div style={{ fontSize: '14px', fontWeight: 800, color: 'var(--status-success)' }}>{b.available_stock} Video Completed</div>
                      </div>
                      <Link
                        href={`/content-flow?brand=${encodeURIComponent(b.account_name)}`}
                        style={{
                          padding: '8px 14px', borderRadius: '10px', background: 'linear-gradient(135deg, var(--status-success) 0%, var(--status-success) 100%)',
                          color: 'var(--text-primary)', textDecoration: 'none', fontSize: '12px', fontWeight: 700, boxShadow: '0 4px 12px var(--status-success-soft)'
                        }}
                      >
                        Kelola ➡️
                      </Link>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.8fr) minmax(0, 1fr)', gap: '20px', alignItems: 'start' }}>
            ...
            <div style={{ padding: '24px', borderRadius: '18px', background: 'var(--bg-card)', border: '1px solid var(--border)', boxShadow: '0 12px 40px var(--overlay-subtle)', backdropFilter: 'blur(20px)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <Link href="/content-flow" style={{ fontSize: '12px', color: 'var(--link)', textDecoration: 'none', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}>
                  Lihat Semua Konten ➔
                </Link>
              </div>
              ...
              <div>
                ...
                <div style={{ marginBottom: '18px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                    <span style={{ color: 'var(--link)', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '6px' }}>🎵 TikTok</span>
                  ...
                  <div style={{ height: '10px', background: 'var(--bg-secondary)', borderRadius: '6px', overflow: 'hidden', border: '1px solid var(--border)' }}>
                    <div style={{ width: `${stats?.platformStats?.tiktokPct ?? 0}%`, height: '100%', background: 'linear-gradient(90deg, var(--status-info) 0%, var(--link) 100%)', borderRadius: '6px', transition: 'width 0.4s ease' }}></div>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: '18px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                    <span style={{ color: 'var(--link)', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '6px' }}>📘 Facebook</span>
                    <span style={{ color: 'var(--text-secondary)', fontWeight: 700 }}>{stats?.platformStats?.fbPct ?? 0}% Published</span>
                  </div>
                  <div style={{ height: '10px', background: 'var(--bg-secondary)', borderRadius: '6px', overflow: 'hidden', border: '1px solid var(--border)' }}>
                    <div style={{ width: `${stats?.platformStats?.fbPct ?? 0}%`, height: '100%', background: 'linear-gradient(90deg, #2563eb 0%, var(--link) 100%)', borderRadius: '6px', transition: 'width 0.4s ease' }}></div>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ height: '10px', background: 'var(--bg-secondary)', borderRadius: '6px', overflow: 'hidden', border: '1px solid var(--border)' }}>
                    <div style={{ width: `${stats?.platformStats?.igPct ?? 0}%`, height: '100%', background: 'linear-gradient(90deg, var(--status-neutral) 0%, #e879f9 100%)', borderRadius: '6px', transition: 'width 0.4s ease' }}></div>
                  </div>
                </div>
