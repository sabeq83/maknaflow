...
test('launch connectors API exports correct methods', () => {
  const routes = [
    { file: 'app/api/v2/affiliate-studio/brands/[id]/programs/[programId]/runs/launch/route.js', allowed: ['POST'], forbidden: ['GET', 'PUT', 'DELETE', 'PATCH'] }
  ];
...
test('Fase 6 code does not import prompts or scheduling processors', () => {
  const filesToCheck = [
    'lib/affiliate-studio-launch-adapter.js',
    'app/api/v2/affiliate-studio/brands/[id]/programs/[programId]/runs/launch/route.js'
  ];
...
test('Fase 6 does not modify frozen modules', () => {
  const frozenFiles = [
