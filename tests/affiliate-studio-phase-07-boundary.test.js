...
test('recommendations API exports correct methods', () => {
  const routes = [
    { file: 'app/api/v2/affiliate-studio/brands/[id]/programs/[programId]/runs/recommend/route.js', allowed: ['GET'], forbidden: ['POST', 'PUT', 'DELETE', 'PATCH'] }
  ];
...
test('Fase 7 code does not import prompts or scheduling processors', () => {
  const filesToCheck = [
    'lib/affiliate-studio-recommendation-adapter.js',
    'app/api/v2/affiliate-studio/brands/[id]/programs/[programId]/runs/recommend/route.js'
  ];
...
test('Fase 7 does not modify frozen modules', () => {
  const frozenFiles = [
